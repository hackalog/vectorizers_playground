...
data_path: /path/to/repo/vectorizers_playground/data
raw_data_path: /path/to/repo/vectorizers_playground/data/raw
interim_data_path: /path/to/repo/vectorizers_playground/data/interim
processed_data_path: /path/to/repo/vectorizers_playground/data/processed
project_path: /path/to/repo/vectorizers_playground
```
...
>>> for name, location in paths.items():
>>>     print(f"{name}: {location}")
data_path: /alternate/bigdata/path/vectorizers_playground/data
raw_data_path: /alternate/bigdata/path/vectorizers_playground/data/raw
interim_data_path: /alternate/bigdata/path/vectorizers_playground/data/interim
processed_data_path: /alternate/bigdata/path/vectorizers_playground/data/processed
project_path: /alternate/bigdata/path/vectorizers_playground
```
as has `config.ini`:
